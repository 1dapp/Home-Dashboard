                    ...
                    <div class="first-sidemenu">
                        <div class="line-animations">
                            <ul class="resp-tabs-list hor_1">
                                 ...
                                 <li class="resp-tab-active active"><a href="https://1dapp.github.io/Home-Dashboard"><span class="side-menu__icon"></span><img src="https://bullrun.live/Content/assets/img/homepage.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Home"></a></li>
                                <li class="autopool"><a href="https://bullrun.live//Home/Autopool"><span class="side-menu__icon"></span><img src="https://bullrun.live/Content/assets/img/m2.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Autopool"></a></li>
                                <li class="trans"><a href="https://bullrun.live//Home/Transaction"><span class="side-menu__icon"></span><img src="https://bullrun.live/Content/assets/img/m3.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Transations"></a></li>
                                <li class="team2"><a href="https://bullrun.live//Home/Team"><span class="side-menu__icon"></span><img src="https://bullrun.live/Content/assets/img/m4.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Team"></a></li>
                                <li class="media2"><a href="https://bullrun.live//Home/Media"><span class="side-menu__icon"></span><img src="https://bullrun.live/Content/assets/img/m5.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Media"></a></li>
                ...
                <div class="banner banner-color mt-0">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
                        <div class="socialjs">
                            ...
                            <a class="sharebutton facebook btn " style="background-color:#3b5998;color:white" data-basecount="" data-sharetype="facebook" data-text="The page title" title="Share this on Facebook" href="#" data-url="https://bullrun.live/user/signup?referralid=1"><i class=" fa fa-facebook"></i></a>

                            <a class="sharebutton twitter btn" style="background-color:#00acee;color:white" data-basecount="" data-sharetype="twitter" data-text="The page title" data-via="AndreasNorman" data-related="AndreasNorman" title="Share this on Twitter" href="#"><i class=" fa fa-twitter"></i> </a>
                            <a class="sharebutton linkedin btn" style="background-color:#0e76a8;color:white" data-basecount="" data-sharetype="linkedin" data-text="The page title" data-referer="AndreasNorman" data-related="AndreasNorman" title="Share this on LinkedIn" href="#"><i class=" fa fa-linkedin"></i> </a>
            ...
            <div class="col-lg-12 col-sm-12 col-xl-4 col-md-12 ">
                <div class="card">
                    <div class="card-body p-0" style="height:700px;overflow:auto">
                        <a class="twitter-timeline" href="https://twitter.com/INHERIT38092481?ref_src=twsrc%5Etfw">Tweets by BULLRUN V3</a>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">1 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">2 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">3 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">4 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">5 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">6 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">7 Referral necessary</p>
            ...
            <div class="offset-lg-3 col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">8 Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">9 Referral necessary</p>
...
<style>
    ...
    <script src="/Content/assets/plugins/jquery-nice-select/js/nice-select.js"></script>
