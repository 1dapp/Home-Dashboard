...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://1dapp.github.io/signup?referralid=1" + result1.id);

            $('.currentuseridlinknew').html("https://link.trustwallet.com/open_url?coin_id=60&url=https://1dapp.github.io/signup?referralid=1" + result1.id);



            $('.currentuseridlink').val("https://1dapp.github.io/user/signup?referralid=1" + result1.id);

            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https://1dapp.github.io/user/signup?referralid=1" + result1.id);



            $('.sharebutton').attr('data-url', "https://1dapp.github.io/user/signup?referralid=1" + result1.id);
